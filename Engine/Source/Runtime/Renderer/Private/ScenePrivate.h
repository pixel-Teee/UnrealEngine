...
#include "Halton.h"
#include "RayTracing/RayTracingVisualizeBVH.h"
#endif
...
public:
	...
	FIESLightProfile2DResource IESLightProfile2DResources;
	...
	uint32 LastPrimaryRaysHalfResMode = 0;
	uint32 PrimaryRaysFrameInfo = 0;
#endif
...
public:
	...
	*/
	...
	bool IsValidForRayTracing() const { return IsValidRef(RayTraceReflectionEnvs); }
	FSceneRenderTargetItem& GetRenderTarget() const { return ReflectionEnvs->GetRenderTargetItem(); }
	FSceneRenderTargetItem& GetRayTraceRenderTarget() const { return RayTraceReflectionEnvs->GetRenderTargetItem(); }
	TRefCountPtr<IPooledRenderTarget> GetRayTraceReflectionEnvs() const { return RayTraceReflectionEnvs; }

	/**
	* Maintain state to amortize RT cubemap updates
	*/
	int32 CurrentTexelIndex;
	int32 CurrentCubemapIndex;

protected:
	uint32 MaxCubemaps;
	int32 CubemapSize;
	TRefCountPtr<IPooledRenderTarget> ReflectionEnvs;
	TRefCountPtr<IPooledRenderTarget> RayTraceReflectionEnvs;
...
public:
	...
	TBitArray<FDefaultBitArrayAllocator> RayTracingRelevantPrimitiveMap;

	/** A map from primitive ID to whether the primitve is relevant for static processing */
	TBitArray<FDefaultBitArrayAllocator> RayTracingStaticRelevantPrimitiveMap;
	...
	FUnitCubeAABB UnitCubeRayTracingGeometry;

	//Maps lights to their light function shaders
	TMap<const ULightComponent*, int32> RayTracingLightFunctionMap;
	TArray<FLightSceneInfo*> RayTracingLightFunctionLights;
#endif
