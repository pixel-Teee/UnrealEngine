...
public:
	...
	*/
	...
	void AllocateRayTracingTimingTarget(FRHICommandList& RHICmdList);
...
public:
	...
	/** Texture arrays used for compositing ray traced translucency layers */
	TRefCountPtr<IPooledRenderTarget> TranslucencyLayersColor;
	TRefCountPtr<IPooledRenderTarget> TranslucencyLayersDepth;

	/** Texture to accumulate ray tracing timing data*/
	TRefCountPtr<IPooledRenderTarget> RayTracingTiming;
...
public:
	...
	void AllocateHybridTranslucencyTargets(FRHICommandListImmediate& RHICmdList, bool bAnyViewUsesHybridTranslucency);
