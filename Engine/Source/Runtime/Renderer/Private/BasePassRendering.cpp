...
void SetTranslucentRenderState(FMeshPassProcessorRenderState& DrawRenderState, const FMaterial& Material, const EShaderPlatform Platform, ETranslucencyPass::Type InTranslucencyPassType)
{
	if (Material.GetShadingModels().HasShadingModel(MSM_ThinTranslucent))
	{
		...
		{
			if (InTranslucencyPassType == ETranslucencyPass::TPT_StandardTranslucency || InTranslucencyPassType == ETranslucencyPass::TPT_StandardTranslucencyRTRaster 
				|| InTranslucencyPassType == ETranslucencyPass::TPT_AllTranslucency || InTranslucencyPassType == ETranslucencyPass::TPT_AllTranslucencyRTRaster)
			{
			...
			else if (InTranslucencyPassType == ETranslucencyPass::TPT_TranslucencyAfterDOF || InTranslucencyPassType == ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster)
			{
			...
			else if (InTranslucencyPassType == ETranslucencyPass::TPT_TranslucencyAfterDOFModulate || InTranslucencyPassType == ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster)
			{
	...
	ERasterizerCullMode MeshCullMode)
{
	...
	// Ray trace mask batches aren't really transparent, they just use transparent geometry
	bool bRayTraceMask = bTranslucentBasePass && TranslucencyPassType == ETranslucencyPass::TPT_RayTracingTranslucencyMask;

	if (bTranslucentBasePass && !bRayTraceMask)
	{
	...
	if (bRayTraceMask)
	{
		DrawRenderState.SetDepthStencilState(TStaticDepthStencilState<
			...
			0xff, 0xff
		>::GetRHI());
		DrawRenderState.SetStencilRef(0xff);
	}
...
#if RHI_RAYTRACING
	const bool bRayTraced = PrimitiveSceneProxy && PrimitiveSceneProxy->IsRayTracingRelevant() && PrimitiveSceneProxy->IsVisibleInRayTracing();
#else
	const bool bRayTraced = false;
#endif
...
FMeshPassProcessor* CreateTranslucencyStandardRTRasterPassProcessor(const FScene* Scene, const FSceneView* InViewIfDynamicMeshCommand, FMeshPassDrawListContext* InDrawListContext)
{
	FMeshPassProcessorRenderState PassDrawRenderState(Scene->UniformBuffers.ViewUniformBuffer);
	PassDrawRenderState.SetInstancedViewUniformBuffer(Scene->UniformBuffers.InstancedViewUniformBuffer);
	PassDrawRenderState.SetDepthStencilState(TStaticDepthStencilState<false, CF_DepthNearOrEqual>::GetRHI());
	...
	return new(FMemStack::Get()) FBasePassMeshProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, PassDrawRenderState, InDrawListContext, Flags, ETranslucencyPass::TPT_StandardTranslucencyRTRaster);
}
...
FMeshPassProcessor* CreateTranslucencyAfterDOFRTRasterProcessor(const FScene* Scene, const FSceneView* InViewIfDynamicMeshCommand, FMeshPassDrawListContext* InDrawListContext)
{
	FMeshPassProcessorRenderState PassDrawRenderState(Scene->UniformBuffers.ViewUniformBuffer);
	PassDrawRenderState.SetInstancedViewUniformBuffer(Scene->UniformBuffers.InstancedViewUniformBuffer);
	PassDrawRenderState.SetDepthStencilState(TStaticDepthStencilState<false, CF_DepthNearOrEqual>::GetRHI());
	...
	return new(FMemStack::Get()) FBasePassMeshProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, PassDrawRenderState, InDrawListContext, Flags, ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster);
}
...
FMeshPassProcessor* CreateTranslucencyAfterDOFModulateRTRasterProcessor(const FScene* Scene, const FSceneView* InViewIfDynamicMeshCommand, FMeshPassDrawListContext* InDrawListContext)
{
	FMeshPassProcessorRenderState PassDrawRenderState(Scene->UniformBuffers.ViewUniformBuffer);
	PassDrawRenderState.SetInstancedViewUniformBuffer(Scene->UniformBuffers.InstancedViewUniformBuffer);
	PassDrawRenderState.SetDepthStencilState(TStaticDepthStencilState<false, CF_DepthNearOrEqual>::GetRHI());
	...
	return new(FMemStack::Get()) FBasePassMeshProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, PassDrawRenderState, InDrawListContext, Flags, ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster);
}
...
FMeshPassProcessor* CreateTranslucencyAllRTRasterPassProcessor(const FScene* Scene, const FSceneView* InViewIfDynamicMeshCommand, FMeshPassDrawListContext* InDrawListContext)
{
	FMeshPassProcessorRenderState PassDrawRenderState(Scene->UniformBuffers.ViewUniformBuffer);
	PassDrawRenderState.SetInstancedViewUniformBuffer(Scene->UniformBuffers.InstancedViewUniformBuffer);
	PassDrawRenderState.SetDepthStencilState(TStaticDepthStencilState<false, CF_DepthNearOrEqual>::GetRHI());
	...
	return new(FMemStack::Get()) FBasePassMeshProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, PassDrawRenderState, InDrawListContext, Flags, ETranslucencyPass::TPT_AllTranslucencyRTRaster);
}

FMeshPassProcessor* CreateTranslucencyRTMaskPassProcessor(const FScene* Scene, const FSceneView* InViewIfDynamicMeshCommand, FMeshPassDrawListContext* InDrawListContext)
{
	FMeshPassProcessorRenderState PassDrawRenderState(Scene->UniformBuffers.ViewUniformBuffer);
	PassDrawRenderState.SetInstancedViewUniformBuffer(Scene->UniformBuffers.InstancedViewUniformBuffer);

	PassDrawRenderState.SetDepthStencilState(TStaticDepthStencilState<false, CF_DepthNearOrEqual, true, CF_Always, SO_Keep, SO_Keep, SO_SaturatedIncrement>::GetRHI());
	PassDrawRenderState.SetBlendState(TStaticBlendState<CW_NONE>::GetRHI());
	PassDrawRenderState.SetDepthStencilAccess(FExclusiveDepthStencil::DepthRead_StencilWrite);

	const FBasePassMeshProcessor::EFlags Flags = FBasePassMeshProcessor::EFlags::CanUseDepthStencil;

	return new(FMemStack::Get()) FBasePassMeshProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, PassDrawRenderState, InDrawListContext, Flags, ETranslucencyPass::TPT_RayTracingTranslucencyMask);
}
...
FRegisterPassProcessorCreateFunction RegisterTranslucencyRTMaskPass(&CreateTranslucencyRTMaskPassProcessor, EShadingPath::Deferred, EMeshPass::TranslucencyRTMask, EMeshPassFlags::MainView);

FRegisterPassProcessorCreateFunction RegisterTranslucencyStandardRTRasterPass(&CreateTranslucencyStandardRTRasterPassProcessor, EShadingPath::Deferred, EMeshPass::TranslucencyStandardRTRaster, EMeshPassFlags::MainView);
FRegisterPassProcessorCreateFunction RegisterTranslucencyAfterDOFRTRasterPass(&CreateTranslucencyAfterDOFRTRasterProcessor, EShadingPath::Deferred, EMeshPass::TranslucencyAfterDOFRTRaster, EMeshPassFlags::MainView);
FRegisterPassProcessorCreateFunction RegisterTranslucencyAfterDOFModulateRTRasterPass(&CreateTranslucencyAfterDOFModulateRTRasterProcessor, EShadingPath::Deferred, EMeshPass::TranslucencyAfterDOFModulateRTRaster, EMeshPassFlags::MainView);
FRegisterPassProcessorCreateFunction RegisterTranslucencyAllRTRasterPass(&CreateTranslucencyAllRTRasterPassProcessor, EShadingPath::Deferred, EMeshPass::TranslucencyAllRTRaster, EMeshPassFlags::MainView);