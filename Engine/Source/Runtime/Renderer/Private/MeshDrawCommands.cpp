...
)
{
	...
	switch (PassType)
	{
		...
		case EMeshPass::TranslucencyRTMask: TaskContext.TranslucencyPass = ETranslucencyPass::TPT_RayTracingTranslucencyMask; break;

		case EMeshPass::TranslucencyStandardRTRaster: TaskContext.TranslucencyPass = ETranslucencyPass::TPT_StandardTranslucencyRTRaster; break;
		case EMeshPass::TranslucencyAfterDOFRTRaster: TaskContext.TranslucencyPass = ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster; break;
		case EMeshPass::TranslucencyAfterDOFModulateRTRaster: TaskContext.TranslucencyPass = ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster; break;
		case EMeshPass::TranslucencyAllRTRaster: TaskContext.TranslucencyPass = ETranslucencyPass::TPT_AllTranslucencyRTRaster; break;
