...
static const TCHAR* TranslucencyPassToString(ETranslucencyPass::Type TranslucencyPass)
{
	...
	case ETranslucencyPass::TPT_AllTranslucency:
		return TEXT("All");
	case ETranslucencyPass::TPT_RayTracingTranslucencyMask:
		return TEXT("RayTracingMask");
	case ETranslucencyPass::TPT_StandardTranslucencyRTRaster:
		return TEXT("HybridTranslucencyStandard");
	case ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster:
		return TEXT("HybridTranslucencyAfterDOF");
	case ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster:
		return TEXT("HybridTranslucencyAfterDOFModulate");
	case ETranslucencyPass::TPT_AllTranslucencyRTRaster:
		return TEXT("HybridTranslucencyAll");
	}
	checkNoEntry();
	return TEXT("");
}
...
EMeshPass::Type TranslucencyPassToMeshPass(ETranslucencyPass::Type TranslucencyPass)
{
	...
	case ETranslucencyPass::TPT_RayTracingTranslucencyMask: TranslucencyMeshPass = EMeshPass::TranslucencyRTMask; break;
	case ETranslucencyPass::TPT_StandardTranslucencyRTRaster: TranslucencyMeshPass = EMeshPass::TranslucencyStandardRTRaster; break;
	case ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster: TranslucencyMeshPass = EMeshPass::TranslucencyAfterDOFRTRaster; break;
	case ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster: TranslucencyMeshPass = EMeshPass::TranslucencyAfterDOFModulateRTRaster; break;
	case ETranslucencyPass::TPT_AllTranslucencyRTRaster: TranslucencyMeshPass = EMeshPass::TranslucencyAllRTRaster; break;
	}
...
{
	ETranslucencyView TranslucencyView = ETranslucencyView::None;
#if RHI_RAYTRACING
	EHybridTranslucencyMode HybridTranslucencyMode = GetRayTracingHybridTranslucencyMode(View);
	switch (HybridTranslucencyMode)
	{
	case EHybridTranslucencyMode::Mode1:
		if (ShouldRenderRayTracingTranslucency(View))
		{
			TranslucencyView = ETranslucencyView::RayTracing;
		}
		break;
	case EHybridTranslucencyMode::Mode2:
		if (ShouldRenderRayTracingTranslucency(View))
		{
			return ETranslucencyView::RayTracing | ETranslucencyView::RayTracingRaster;
		}
		break;
	default:
		if (ShouldRenderRayTracingTranslucency(View))
...
#endif
	EnumAddFlags( TranslucencyView, View.IsUnderwater() ? ETranslucencyView::UnderWater : ETranslucencyView::AboveWater);
...
static bool IsMainTranslucencyPass(ETranslucencyPass::Type TranslucencyPass)
{
	return TranslucencyPass == ETranslucencyPass::TPT_AllTranslucency || TranslucencyPass == ETranslucencyPass::TPT_StandardTranslucency
		|| TranslucencyPass == ETranslucencyPass::TPT_AllTranslucencyRTRaster || TranslucencyPass == ETranslucencyPass::TPT_StandardTranslucencyRTRaster;
}
...
static bool IsSeparateTranslucencyEnabled(ETranslucencyPass::Type TranslucencyPass, float DownsampleScale)
{
	...
	if (TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOF || TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFModulate
		|| TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster || TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster
	)
	{
		return true;
	}
	...
	if (HasSeparateTranslucencyTimer(View))
	{
		AddPass(GraphBuilder, [&View, TranslucencyPass](FRHICommandListImmediate& RHICmdList)
		{
			if (TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFModulate
				|| TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster
				)
			{
...
FSeparateTranslucencyDimensions UpdateTranslucencyTimers(FRHICommandListImmediate& RHICmdList, TArrayView<const FViewInfo> Views)
{
	...
	bool bAnyViewWantsHybridTranslucency = false;
		...
		for (int32 ViewIndex = 0; ViewIndex < Views.Num(); ViewIndex++)
		{
			...
			if (ViewState)
			{
				...
				if (bSeparateTranslucencyAutoDownsample && bSeparateTransTimerSuccess)
				{
					...
					bAnyViewWantsHybridTranslucency = bAnyViewWantsHybridTranslucency || GetRayTracingHybridTranslucencyMode(View) != EHybridTranslucencyMode::None;
				}
			}
		}
	}
	...
	if (bAnyViewWantsHybridTranslucency && EffectiveScale != 1.0f)
	{
		EffectiveScale = 1.0f;

#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
		const uint64 Label = 0x4854524E;  //FOURCC for HTRN
		GEngine->AddOnScreenDebugMessage(Label, 60.0f, FColor::Red, TEXT("WARNING: Hybrid translucency conflicts with separate translucency screen percentage!\n Overriding screen percentage"));
#endif
	}
...
bool FSceneRenderer::ShouldRenderTranslucency(ETranslucencyPass::Type TranslucencyPass) const
{
	...
	if (GLightShaftRenderAfterDOF && (TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOF || TranslucencyPass == ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster))
	{
		return true;
	}
	...
	int32 TranslucencyPass)
{
	...
	BasePassParameters.RayTracingTranslucencyLayerCount = 0;
	BasePassParameters.RayTracingTTranslucencyUpscale = 0;
	BasePassParameters.RayTracingTranslucencyLayerDepthThreshold = -1.0f;
	BasePassParameters.RayTracingTranslucencyLayersColor = GSystemTextures.TextureArrayBlackDummy->GetRenderTargetItem().ShaderResourceTexture;
	BasePassParameters.RayTracingTranslucencyLayersDepth = GSystemTextures.TextureArrayBlackDummy->GetRenderTargetItem().ShaderResourceTexture;

#if RHI_RAYTRACING
	static const auto HybridTranslucencyDepthThresholdCVar = IConsoleManager::Get().FindTConsoleVariableDataFloat(TEXT("r.RayTracing.Translucency.HybridDepthThreshold"));
	static const auto HybridTranslucencyDepthBiasCVar = IConsoleManager::Get().FindTConsoleVariableDataFloat(TEXT("r.RayTracing.Translucency.HybridDepthBias"));
	static const auto RayTraingTranslucencyHalfResCVar = IConsoleManager::Get().FindTConsoleVariableDataInt(TEXT("r.RayTracing.Translucency.HalfRes"));

	if (ShouldRenderRayTracingTranslucency(View) && GetRayTracingHybridTranslucencyMode(View) == EHybridTranslucencyMode::Mode1)
	{
		int32 MaxTranslucencyLayers = MaxHybridTranslucencyLayers();

		BasePassParameters.RayTracingTranslucencyType = 1;
		BasePassParameters.RayTracingTranslucencyLayerCount = MaxTranslucencyLayers;
		BasePassParameters.RayTracingTTranslucencyUpscale = RayTraingTranslucencyHalfResCVar ? RayTraingTranslucencyHalfResCVar->GetValueOnRenderThread() : 0;
		BasePassParameters.RayTracingTranslucencyLayerDepthThreshold = HybridTranslucencyDepthThresholdCVar ? HybridTranslucencyDepthThresholdCVar->GetValueOnAnyThread() : 0.2f;
		BasePassParameters.RayTracingTranslucencyLayersColor = SceneRenderTargets.TranslucencyLayersColor->GetRenderTargetItem().ShaderResourceTexture;
		BasePassParameters.RayTracingTranslucencyLayersDepth = SceneRenderTargets.TranslucencyLayersDepth->GetRenderTargetItem().ShaderResourceTexture;
	}
	else if (ShouldRenderRayTracingTranslucency(View) && GetRayTracingHybridTranslucencyMode(View) == EHybridTranslucencyMode::Mode2 && (
				ETranslucencyPass::Type(TranslucencyPass) == ETranslucencyPass::TPT_StandardTranslucencyRTRaster
				|| ETranslucencyPass::Type(TranslucencyPass) == ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster
				|| ETranslucencyPass::Type(TranslucencyPass) == ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster
				|| ETranslucencyPass::Type(TranslucencyPass) == ETranslucencyPass::TPT_AllTranslucencyRTRaster
				)
		)
	{
		int32 MaxTranslucencyLayers = MaxHybridTranslucencyLayers();

		BasePassParameters.RayTracingTranslucencyType = 2;
		BasePassParameters.RayTracingTranslucencyLayerCount = MaxTranslucencyLayers;
		BasePassParameters.RayTracingTTranslucencyUpscale = RayTraingTranslucencyHalfResCVar ? RayTraingTranslucencyHalfResCVar->GetValueOnRenderThread() : -1;
		BasePassParameters.RayTracingTranslucencyLayerDepthThreshold = HybridTranslucencyDepthBiasCVar ? HybridTranslucencyDepthBiasCVar->GetValueOnAnyThread() : 0.2f;// Working as DepthBias in HT mode 2
		BasePassParameters.RayTracingTranslucencyLayersColor = SceneRenderTargets.TranslucencyLayersColor->GetRenderTargetItem().ShaderResourceTexture;
		BasePassParameters.RayTracingTranslucencyLayersDepth = SceneRenderTargets.TranslucencyLayersDepth->GetRenderTargetItem().ShaderResourceTexture;
	}
#endif
	...
	int32 TranslucencyPass)
{
	...
	SetupTranslucentBasePassUniformParameters(&GraphBuilder, GraphBuilder.RHICmdList, SceneRenderTargets, View, SceneColorCopyTexture, SceneTextureSetupMode, ViewIndex, *BasePassParameters, TranslucencyPass);
	...
	int32 TranslucencyPass)
{
	...
	FTranslucentBasePassUniformParameters BasePassParameters;
	SetupTranslucentBasePassUniformParameters(nullptr, RHICmdList, SceneRenderTargets, View, nullptr, SceneTextureSetupMode, ViewIndex, BasePassParameters, TranslucencyPass);
		...
		for (int32 ViewIndex = 0, NumProcessedViews = 0; ViewIndex < Views.Num(); ++ViewIndex, ++NumProcessedViews)
		{
			...
			RenderTranslucencyViewInner(
				...
				*this,
				...
				CreateTranslucentBasePassUniformBuffer(GraphBuilder, View, SceneColorCopyTexture, SceneTextureSetupMode, ViewIndex, int32(TranslucencyPass)),
				TranslucencyPass,
...
void FDeferredShadingSceneRenderer::RenderTranslucency(
	...
	ETranslucencyView ViewsToRender)
{
	if (!EnumHasAnyFlags(ViewsToRender, ETranslucencyView::UnderWater | ETranslucencyView::AboveWater | ETranslucencyView::RayTracingMask | ETranslucencyView::RayTracingRaster))
	{
		return;
	}
	...
	if (EnumHasAnyFlags(ViewsToRender, ETranslucencyView::RayTracingMask))
	{
		//stencil mask for raytraced translucency
		RenderTranslucencyInner(GraphBuilder, SceneColorTexture, SceneDepthTexture, OutSeparateTranslucencyTextures, ViewsToRender, SceneColorCopyTexture, ETranslucencyPass::TPT_RayTracingTranslucencyMask);
	}
	else if (EnumHasAnyFlags(ViewsToRender, ETranslucencyView::RayTracingRaster))
	{
		if (ViewFamily.AllowTranslucencyAfterDOF())
		{
			RenderTranslucencyInner(GraphBuilder, SceneColorTexture, SceneDepthTexture, OutSeparateTranslucencyTextures, ViewsToRender, SceneColorCopyTexture, ETranslucencyPass::TPT_StandardTranslucencyRTRaster);
			RenderTranslucencyInner(GraphBuilder, SceneColorTexture, SceneDepthTexture, OutSeparateTranslucencyTextures, ViewsToRender, SceneColorCopyTexture, ETranslucencyPass::TPT_TranslucencyAfterDOFRTRaster);
			RenderTranslucencyInner(GraphBuilder, SceneColorTexture, SceneDepthTexture, OutSeparateTranslucencyTextures, ViewsToRender, SceneColorCopyTexture, ETranslucencyPass::TPT_TranslucencyAfterDOFModulateRTRaster);
		}
		else // Otherwise render translucent primitives in a single bucket.
		{
			RenderTranslucencyInner(GraphBuilder, SceneColorTexture, SceneDepthTexture, OutSeparateTranslucencyTextures, ViewsToRender, SceneColorCopyTexture, ETranslucencyPass::TPT_AllTranslucencyRTRaster);
		}
	}
	else
	{
