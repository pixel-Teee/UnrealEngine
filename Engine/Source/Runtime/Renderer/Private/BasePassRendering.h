...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FTranslucentBasePassUniformParameters,)
	...
	SHADER_PARAMETER(int, RayTracingTranslucencyLayerCount)
	SHADER_PARAMETER(int, RayTracingTTranslucencyUpscale)
	SHADER_PARAMETER(float, RayTracingTranslucencyLayerDepthThreshold)
	SHADER_PARAMETER(int, RayTracingTranslucencyType)
	...
	SHADER_PARAMETER_TEXTURE(Texture2DArray<float4>, RayTracingTranslucencyLayersColor)
	SHADER_PARAMETER_TEXTURE(Texture2DArray<float>, RayTracingTranslucencyLayersDepth)
END_GLOBAL_SHADER_PARAMETER_STRUCT()
