...
void ULightComponentBase::SetSupportSampledLighting(bool bNewValue)
{
	if (AreDynamicDataChangesAllowed()
		&& bSupportSampledLighting != bNewValue)
	{
		bSupportSampledLighting = bNewValue;
		MarkRenderStateDirty();
	}
...
FLightSceneProxy::FLightSceneProxy(const ULightComponent* InLightComponent)
	...
	, bCastRaytracedShadow(InLightComponent->CastShadows && InLightComponent->bCastRaytracedShadow)
	, bAffectReflection(InLightComponent->bAffectReflection)
	, bAffectGlobalIllumination(InLightComponent->bAffectGlobalIllumination)
	, bSupportSampledLighting(InLightComponent->bSupportSampledLighting)
...
void ULightComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	...
	if( PropertyName != GET_MEMBER_NAME_STRING_CHECKED(ULightComponent, CastTranslucentShadows) &&
		...
		PropertyName != GET_MEMBER_NAME_STRING_CHECKED(ULightComponent, bSupportSampledLighting) &&
