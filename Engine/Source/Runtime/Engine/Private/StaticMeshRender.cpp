...
bool FStaticMeshSceneProxy::UseRayTracingShadowBias() const
{
	...
	bool bUseBiasForSkipWPOEval = UseShadowBiasForSkipWPOEvalCVar->GetValueOnRenderThread() > 0 || UseAmbientOcclusionBiasForSkipWPOEvalCVar->GetValueOnAnyThread() > 0;
	bool bSkipWPOEvaluation = !bDynamicRayTracingGeometry && MaterialRelevance.bUsesWorldPositionOffset;
	
	return bUseBiasForSkipWPOEval && bSkipWPOEvaluation;
}
