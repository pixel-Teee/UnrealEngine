...
/** Draw timing for Ray Tracing */
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeRayTiming, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeRayTracingTiming", "Visualize Ray Tracing Timing"))
/** Draw BVH complexity for Ray Tracing */
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeBVHComplexity, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeBVHComplexity", "Visualize BVH Complexity"))
/** Draw BVH overlap for Ray Tracing */
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeBVHOverlap, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeBVHOverlap", "Visualize BVH Overlap"))
// RHI_RAYTRACING end
